...
namespace VNStory.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IAuthenticationManager authenticationMangaer)
        {
            UserManager = userManager;
            SignInManager = signInManager;
            _authenticationMangaer = authenticationMangaer;
        }
        ...
        public IAuthenticationManager AuthenticationManager
        {
            get
            {
                return _authenticationMangaer ?? HttpContext.GetOwinContext().Authentication;
            }
            private set
            {
                _authenticationMangaer = value;
            }
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            ApplicationUser applicationUser = UserManager.Users.FirstOrDefault(u => u.Email.Equals(model.Email));

            if (applicationUser != null)
            {
                // This doesn't count login failures towards account lockout
                // To enable password failures to trigger account lockout, change to shouldLockout: true
                var result = await SignInManager.PasswordSignInAsync(applicationUser.UserName, model.Password, model.RememberMe, shouldLockout: false);
