...
namespace VNStory.Web.Areas.Admin.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            var users = allUsers.Select(u => new UsersViewModel { Id = u.Id, UserName = u.UserName, Email = u.Email, Roles = String.Join(", ", allRoles.Where(role => role.Users.Any(user => user.UserId == u.Id)).Select(r => r.Name)) }).ToList();
